...
- [ ] T001 Update `src/config.py` with new dataclass fields
...
- [ ] T006 Update `src/fetcher.py` (if API changes needed)
...
### Implementation
- [ ] T009 [P] [US1] Implement rendering logic in `src/[card_module].py`
...
- [ ] TXXX Run `ruff check .` and fix violations
- [ ] TXXX Run `ruff format .`
- [ ] TXXX Run `mypy .` and fix typing errors
